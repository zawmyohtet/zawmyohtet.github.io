---
title: "Agent Playground is here!"
description: 'Containerized development environment designed for building and experimenting with agentic applications'
publishDate: 2025-09-14 21:00:00
language: 'English' 
heroImage: { src: './agent-playground.png', alt: 'agent playground', color: '#B4C6DA' }
tags: ["docker", "jupyter", "python", "nodejs", "mcp"]
comment: false
---
...
While I am preparing containerised developments for agentic application developments for myself, I thought it would be a great idea to share this with others. [So here you go](https://github.com/zawmyohtet/agent-playground).  
